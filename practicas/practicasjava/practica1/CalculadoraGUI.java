package practicas.practicasjava.practica1;
...
public class CalculadoraGUI extends JFrame implements ActionListener,MouseListener{
    ...
    JButton btn_6,btn_7,btn_8,btn_9;
    JButton btn_div,btn_suma,btn_resta,btn_potencia,btn_mult,btn_igual;
    JTextField barra;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (contador<=3) {
            ...
            JOptionPane.showMessageDialog(null,"Solo puedes agregar 3 elementos");
        }
        
    }
    public static void main(String[] args) {
        CalculadoraGUI cal1=new CalculadoraGUI("Calculadora Simple");
    }
    @Override
